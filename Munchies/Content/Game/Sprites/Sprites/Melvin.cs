...
namespace Munchies
{
    public class Melvin : Sprite
    {
        ...
        static string[] butterImageNames = new string[] { 
            "Shield1", "Shield2", "Shield3", "Shield4" };
        static string[] melvinImageNames = new string[] { 
            "MelvinS", 
        ...
        void gameInstance_OnPause(object sender, EventArgs e)
        {
            Cursor.Position = Game.GameContainer.PointToScreen(
                new Point((int)Location.X, (int)Location.Y));
        }

        void gameInstance_OnPlay(object sender, EventArgs e)
        {
            ResetCursorPosToCenter();
        }


        void Melvin_Collide(Sprite sprite2)
        {
